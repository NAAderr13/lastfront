        ...
        <div className="relative isolate px-6 pt-14 lg:px-8">
          ...
          <div className="mx-auto max-w-7xl py-32 sm:py-48 lg:py-20 mt-12 relative rounded-2xl px-3 py-1 text-sm leading-6 text-gray-600 bg-white/50 py-6">
            <div className="text-center">
              <h1 className="text-5xl font-extrabold tracking-tight text-blue-900 sm:text-7xl">
                Share more than your ride
              </h1>
              <p className="mt-6 text-lg sm:text-xl leading-8 text-black">
              ...
              <div className="mt-10 flex flex-col items-center justify-center gap-y-4">
                <div className="flex gap-x-6">
                  <a
                    href="/Offer"
                    className="rounded-md bg-green-600 px-6 py-3 text-lg font-semibold text-white shadow-lg hover:bg-green-500 transition duration-300"
                  >
                    Offer a Ride
                  </a>
                  <a
                    href="/Find"
                    className="rounded-md bg-white px-6 py-3 text-lg font-semibold text-gray-700 shadow-lg hover:bg-white/80 transition duration-300"
                  >
                    Find a Ride
                  </a>
                </div>
                <a
                  className="text-indigo-800 hover:underline mt-6 border-2 border-indigo-800 rounded-full px-6 py-3 transition duration-300"
                  href="/Login"
                >
                  Sign in
                </a>
